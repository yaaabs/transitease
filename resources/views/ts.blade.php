...
<html class="no-js" lang="zxx">
    ...
    <head>
		...
		<!-- Title -->
        <title>TransitEase - Train Schedule</title>
...
<div class="container">
  <div class="image-gallery">
    <div class="row">
      <div class="col-md-12">
        <img src="img/TS.jfif" alt="Train Schedule" data-bs-toggle="modal" data-bs-target="#imageModalTrainSchedule">
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="imageModalTrainSchedule" tabindex="-1" aria-labelledby="imageModalTrainScheduleLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="img/TS.jfif" alt="Train Schedule" class="img-fluid">
      </div>
    </div>
  </div>
</div>
...
<br><br>
  ...
  <div class="container">
    <section class="qwerty" id="home">
      <div class="card">
        <div class="imgBx">
          <img src="img/zzz/2.png">
        </div>
        <div class="content">
          <div>
            <h2><b>4:30 AM</b></h2>
            <p><b>First Train</b> from <b>Baclaran Station</b> on Weekdays.</p>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="imgBx">
          <img src="img/zzz/3.png">
        </div>
        <div class="content">
          <div>
            <h2><b>4:30 AM</b></h2>
            <p><b>First Train</b> from <b>Fernando Poe Jr. Station</b> <i>(formerly Roosevelt Station)</i> on Weekdays.</p>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="imgBx">
          <img src="img/zzz/4.png">
        </div>
        <div class="content">
          <div>
            <h2><b>5:00 AM</b></h2>
            <p><b>First Train</b> from <b>Both Stations</b> on Weekends and Holidays.</p>
          </div>
        </div>
      </div>
    </section>
  ...
  <div class="container">
    <section class="qwerty" id="home">
      <div class="card">
        <div class="imgBx">
          <img src="img/zzz/5.png">
        </div>
        <div class="content">
          <div>
             <h2><b>10:00 PM</b></h2>
             <p><b>Last Train</b> from <b>Baclaran Station</b> on Weekdays.</p>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="imgBx">
          <img src="img/zzz/6.png">
        </div>
        <div class="content">
          <div>
          <h2><b>10:15 PM</b></h2>
          <p><b>Last Train</b> from <b>Fernando Poe Jr. Station</b> <i>(formerly Roosevelt Station)</i> on Weekdays.</p>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="imgBx">
          <img src="img/zzz/7.png">
        </div>
        <div class="content">
          <div>
             <h2><b>9:30 / 9:45 PM</b></h2>
             <p><b>Last Train</b> from <b>Baclaran Station</b> <br>(9:30 PM) & from </b>Fernando Poe Jr. Station</b> <i>(formerly Roosevelt Station)</i><br> (9:45 PM) on Weekends and Holidays.</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="card-body">
            <div class="row mx-md-5 px-lg-5 d-flex align-items-center">
                <div class="col-md-7 p-2 text-center text-md-left">
                    <p class="text-secondary font-size-sm">LRT-1 Operating Hours.</p><br>
                    <h3 class="poppins-bold dark-green"><i class="icofont-info-circle"></i><justify><b>Note:</b> You can check if the gate is closed or ask the guards if you can still ride the train.</justify></h3>
                </div>
                <div class="col-md-5 text-center text-md-right p-0">
                    <img src="img/TS.jfif" class="img-fluid w-75"
                        alt="">
                </div>
            </div>
        </div>
