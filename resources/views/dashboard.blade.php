...
<head>
    ...
    <title>TransitEase Admin - Dashboard</title>
    <link rel="icon" type="image/x-icon" href="img/PLEASE.png">
...
<body id="page-top">
                            ...
                            <div class="main-menu">
                                <nav class="navigation">
                                    <ul class="nav menu">
                                        ...
                                        <li class="{{ Request::is('page') ? 'active' : '' }}"><a href="{{ route('page') }}">TransitEase<i class="icofont-rounded-down" aria-hidden="true"></i></a></li>
                                        @auth
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-warning sidebar" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard">
                ...
                <div class="sidebar-brand-text mx-3">TransitEase<sup></sup></div>
            </a>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="img/TE Logo.png" alt="...">
                <p class="text-center mb-2"><strong>TransitEase</strong> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                <a class="btn btn-primary btn-sm" href="#">Lorem ipsum!</a>
            </div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">TransitEase Admin Dashboard</h1>
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Lorem Ipsum</a>
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Lorem (Ipsum)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">$69,999</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Lorem (Ipsum)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">$696,999</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Lorem
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Lorem
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-warning"></i> Ipsum
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-dark"></i> Dolor
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Ipsum</h6>
                                </div>
                                <div class="card-body">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; TransitEase 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
