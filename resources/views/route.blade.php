...
<html class="no-js" lang="zxx">
    ...
    <head>
		...
		<!-- Title -->
        <title>TransitEase - Train Route</title>
  ...
  <div class="container">
    <section class="qwerty" id="home">
      <div class="card">
        ...
        <div class="content">
          <div>
            <h2><b>Blumentritt</b></h2>
            <p>This station is <em>immediately above</em> its <b>PNR Metro Commuter Line</b> counterpart.</p>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="imgBx">
          <img src="img/TRDJ.jpg">
        </div>
        <div class="content">
          <div>
            <h2><b>Doroteo Jose</b></h2>
            <p>DJose Station is <em>indirectly connected</em> to <b>Recto</b> of the <b>LRT Line 2</b> through a covered walkway.</p>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="imgBx">
          <img src="img/TREDSA.jpg">
        </div>
        <div class="content">
          <div>
            <h2><b>EDSA</b></h2>
            <p>While EDSA Station is <em>connected</em> to the <b>Taft Avenue</b> station via a covered walkway.</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="card-body">
            <div class="row mx-md-5 px-lg-5 d-flex align-items-center">
                <div class="col-md-7 p-2 text-center text-md-left">
                    <p class="text-secondary font-size-sm">LRT-1 Train Routes</p><br>
                    <h3 class="poppins-bold dark-green"><i class="icofont-info-circle"></i><justify><b> Note:</b> The line serves 20 stations along its route. A few stations is yet to be constructed.</justify></h3>
                </div>
                <div class="col-md-5 text-center text-md-right p-0">
                    <img src="img/Route.png" class="img-fluid w-75"
                        alt="">
                </div>
            </div>
        </div>
